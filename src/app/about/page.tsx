                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-10">
                    ...
                    >
                        <div className="inline-flex items-center gap-3 bg-white text-primary px-4 py-2 rounded-full border border-slate-200 mb-10 shadow-sm">
                            <span className="text-xs font-bold uppercase tracking-wider">About SwiftLink Shipping</span>
                        </div>
                        ...
                        <p className="text-xl md:text-2xl text-slate-500 font-medium leading-relaxed max-w-3xl">
                            Since 2026, SwiftLink Shipping has been on a mission to make world trade accessible to everyone. We combine advanced technology with a human touch to deliver your packages safely and on time.
                        </p>
                    </motion.div>
                </div>
                    ...
                    <div className="space-y-12">
                        <div className="space-y-6">
                            ...
                            <p className="text-slate-500 text-lg leading-relaxed font-medium">
                                SwiftLink Shipping started with a simple idea: shipping shouldn't be complicated. What began as a small regional delivery service has grown into a global network that connects businesses and people across continents.
                            </p>
                            <p className="text-slate-500 text-lg leading-relaxed font-medium">
