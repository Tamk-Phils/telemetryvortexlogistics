    ...
    const sections = [
        {
            title: "DATA OVERVIEW",
            icon: Eye,
            content: "At SwiftLink Shipping, we prioritize the integrity of your transit data. This service describes how we sync, secure, and manage your data when you utilize our global tracking services."
        },
        {
        ...
        },
        {
            ...
            icon: ShieldCheck,
            content: "SwiftLink Shipping implements enterprise-grade cryptographic measures. All information are encrypted at rest and during transit between offices using advanced secure services."
        },
        {
            ...
            <div className="container mx-auto px-6 max-w-5xl">
                ...
                >
                    ...
                    <div className="mt-24 p-12 bg-slate-900 rounded-sm text-white text-center shadow-3xl relative overflow-hidden">
                        ...
                        <p className="text-primary font-black text-2xl uppercase tracking-tighter hover:text-white transition-colors cursor-pointer">SUPPORT@SWIFTLINKSHIPPING.COM</p>
                    </div>
                </motion.div>
            </div>
        </main>
