...
export default function UsagePage() {
    return (
        <main className="bg-white min-h-screen">
                ...
                <div className="container mx-auto px-6 max-w-7xl relative z-10 text-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-slate-500 font-medium max-w-3xl mx-auto leading-relaxed">
                            Everything you need to know about using the SwiftLink Shipping platform safely and effectively. We've simplified our rules to help you get moving faster.
                        </p>
                    </motion.div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
                    <div className="space-y-16">
                        <div className="space-y-6">
                            ...
                            <p className="text-lg text-slate-500 font-medium">Follow these simple steps to start shipping with SwiftLink Shipping today.</p>
                        </div>
            ...
            <section className="py-32 container mx-auto px-6 max-w-7xl">
               <div className="text-center mb-24">
                   <h2 className="text-4xl font-black text-slate-900 tracking-tight mb-6">SwiftLink Shipping in Action</h2>
