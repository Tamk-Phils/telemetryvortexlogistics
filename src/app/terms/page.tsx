            ...
            <div className="container mx-auto px-6 max-w-5xl">
                ...
                >
                    ...
                    <p className="text-xl text-slate-500 font-bold leading-relaxed uppercase tracking-tight">
                        Last Modified: May 2026. Please sync with these services before utilizing the SwiftLink Shipping Data Network.
                    </p>
                </motion.div>
                ...
                <div className="space-y-20">
                    <section className="group">
                        ...
                        <div className="text-slate-500 font-bold text-sm uppercase tracking-tight leading-relaxed pl-20 space-y-4">
                            <p>By accessing the SwiftLink Shipping platform, you agree to be bound by these Charter services. If you are operating on behalf of an institution, you represent that you have the authority to bind that office to these terms.</p>
                            <p>SwiftLink Shipping reserves the right to modify these services at any millisecond. Continued data sync constitutes acceptance of the new charter.</p>
                        </div>
                    </section>
                    ...
                    <section className="group">
                        ...
                        <div className="text-slate-500 font-bold text-sm uppercase tracking-tight leading-relaxed pl-20 space-y-4">
                            <p>We prioritize the security of your transit data. All tracking signatures are encrypted in transit. You retain ownership of all data submitted, but grant SwiftLink Shipping a non-exclusive license to use such data to optimize the global network.</p>
                        </div>
                    </section>
                    ...
                    <section className="group">
                        ...
                        <div className="text-slate-500 font-bold text-sm uppercase tracking-tight leading-relaxed pl-20 space-y-4">
                            <p>Operators are strictly prohibited from reverse engineering the SwiftLink autonomous algorithms, attempting to bypass office rate limits, or using the platform for unauthorized asset tracking.</p>
                        </div>
                    </section>
                    ...
                    <section className="p-16 bg-slate-50 rounded-sm border border-slate-200 flex flex-col md:flex-row justify-between items-center gap-10 shadow-3xl">
                        ...
                        <a href="mailto:support@swiftlinkshipping.com" className="bg-slate-900 px-12 py-5 rounded-sm font-black text-white text-[10px] uppercase tracking-widest hover:bg-primary transition-all shadow-xl">
                            CONTACT COMPLIANCE
                        </a>
                    </section>
                </div>
